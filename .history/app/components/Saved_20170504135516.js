              ...
              <li className="list-group-item resultdiv" >
                ...
                <h3>
                  ...
                  <span className="btn-group pull-right" >
                    <a href={article.url} target="_blank"><button className="btn btn-default myButton">View Article</button></a>
                    <span></span><span></span><button className="btn btn-primary myButton" onClick={this.handleClick.bind(this, article)}>Delete</button>
                  </span>
                </h3>
