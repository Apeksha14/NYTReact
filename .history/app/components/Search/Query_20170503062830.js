		...
		<div className="login-form">
			<div className="sign-in-htm">
				<div className="group">
					...
					<input value={this.state.value} onChange= {this.handleChange} id="user" type="text" className="input"/>
				</div>
				<div className="group">
					<label htmlFor="start" className="label">Start Year</label>
					<input value={this.state.value}  id="start" type="text" className="input"/>
				</div>
        <div className="group">
